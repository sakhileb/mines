...
<head>
    ...
    <title>403 – Forbidden | {{ config('app.name', 'Mines') }}</title>
...
<body>
    <div class="container">
        ...
        <h1>Access Denied</h1>
        <p>You don't have permission to access this resource. If you believe this is an error, please contact your team administrator.</p>
