    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900
        ...
        <div class="space-y-4">
            ...
            <div class="bg-gray-800 border border-gray-700 rounded-lg shadow-lg p-6">
                <div class="space-y-2">
                    <button 
                        wire:click="@if($view === 'create')create @else update @endif"
                    ...
                    >
                        @if($view === 'create')
                            <span wire:loading.remove>Create Mine Area</span>
                            <span wire:loading>Creating...</span>
                        @else
                            <span wire:loading.remove>Update Mine Area</span>
    ...
    <div class="bg-gray-800 rounded-lg w-full max-w-md border border-gray-700" @click.stop>
        ...
        <div class="p-6 space-y-4">
            ...
            <div>
                ...
                />
                @error('shiftName') <p class="mt-1 text-sm text-red-400">{{ $message }}</p> @enderror
            </div>
            ...
            <div>
                ...
                <input 
                    ...
                    class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-blue-500"
                />
                @error('shiftStartTime') <p class="mt-1 text-sm text-red-400">{{ $message }}</p> @enderror
            </div>
            ...
            <div>
                ...
                <input 
                    ...
                    class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-2-blue-500"
                />
                @error('shiftEndTime') <p class="mt-1 text-sm text-red-400">{{ $message }}</p> @enderror
            </div>
                ...
                <div class="grid grid-cols-2 gap-2">
                    @foreach(['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'] as $day)
                        <label class="flex items-center gap-2 px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg cursor-pointer hover:bg-gray-600 transition">
                            ...
                            />
                            <span class="text-sm text-gray-300">{{ ucfirst($day) }}</span>
                        </label>
                    @endforeach
                </div>
                @error('shiftDays') <p class="mt-1 text-sm text-red-400">{{ $message }}</p> @enderror
            </div>
        </div>
...
<div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4" wire:click="closeMaterialModal">
    <div class="bg-gray-800 rounded-lg w-full max-w-md border border-gray-700" @click.stop>
        ...
        <div class="p-6">
            ...
            />
            @error('newMaterialType') <p class="mt-1 text-sm text-red-400">{{ $message }}</p> @enderror
        ...
        <div class="p-6 space-y-4">
            ...
            <div>
                ...
                <input 
                    ...
                    class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-amber-500"
                />
                @error('mining_targets.daily') <p class="mt-1 text-sm text-red-400">{{ $message }}</p> @enderror
            </div>
            ...
            <div>
                ...
                <input 
                    ...
                    class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-amber-500"
                />
                @error('mining_targets.weekly') <p class="mt-1 text-sm text-red-400">{{ $message }}</p> @enderror
            </div>
            ...
            <div>
                ...
                <input 
                    ...
                    class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-amber-500"
                />
                @error('mining_targets.monthly') <p class="mt-1 text-sm text-red-400">{{ $message }}</p> @enderror
            </div>
            ...
            <div>
                ...
                <input 
                    ...
                    class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-amber-500"
                />
                @error('mining_targets.yearly') <p class="mt-1 text-sm text-red-400">{{ $message }}</p> @enderror
            </div>
        </div>
        <div class="p-6 border-t border-gray-700 flex gap-3">
            <button 
