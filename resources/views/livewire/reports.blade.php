    ...
    <div class="max-w-7xl mx-auto">
        ...
        @else
            ...
            <div class="bg-slate-800 rounded-lg border border-slate-700 p-12 text-center">
                ...
                <a href="{{ $generateRoute }}" wire:navigate class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-medium transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                    </svg>
